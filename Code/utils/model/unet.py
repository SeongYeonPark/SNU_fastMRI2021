...
class Unet(nn.Module):
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        self.inc = DoubleConv(in_channels, 64//n)
        self.down1 = Down(64//n, 128//n)
        self.down2 = Down(128//n, 256//n)
        self.down3 = Down(256//n, 512//n)
        self.MHSA = MultiHeadSelfAttention(512//n)
        self.up1 = TransformerUp(512//n, 256//n)
        self.up2 = TransformerUp(256//n, 128//n)
        self.up3 = TransformerUp(128//n, 64//n)
        self.outc = OutConv(64//n, self.classes)
