...
def parse():
    ...
    parser.add_argument('-n', '--net_name', type=Path, default='hinet32', help='Name of network')
    ...
    parser.add_argument("--input_key", type=str, default='image_grappa, image_input', help='Name of input key')
